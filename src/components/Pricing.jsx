    ...
    return (
        <div className='w-full text-white my-24'>
            ...
            <div className='max-w-[1240px] mx-auto py-12'>
                <div className='text-center px-8 text-slate-300'>
                    ...
                    <p className='text-3xl' >Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut vel voluptas repellendus tempore hic minima natus perspiciatis.</p>
                </div>
                ...
                <div className='grid md:grid-cols-2'>
                    ...
                    <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl reative'>
